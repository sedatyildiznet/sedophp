...
if (!function_exists('get')) {
    function get(string $pattern, mixed $action): Route
    {
...
if (!function_exists('post')) {
    function post(string $pattern, mixed $action): Route
    {
...
if (!function_exists('put')) {
    function put(string $pattern, mixed $action): Route
    {
...
if (!function_exists('patch')) {
    function patch(string $pattern, mixed $action): Route
    {
        return app()->router()->patch($pattern, $action);
    }
}

if (!function_exists('delete')) {
    function delete(string $pattern, mixed $action): Route
    {
...
if (!function_exists('view')) {
    ...
    {
        return View::render($name, $data, $status);
    }
}
...
if (!function_exists('login')) {
    ...
    {
        return Auth::attempt($identity, $password);
    }
}
